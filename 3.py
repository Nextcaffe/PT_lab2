...
char BASH_SCRIPT_NAME[17] = "knb_by_python.sh";
...
"""
BASH_SCRIPT_NANE = "2_by_python.sh"
with open(BASH_SCRIPT_NANE, "w") as f:
    f.write(bash_code)

subprocess.check_call(['chmod', '+x', BASH_SCRIPT_NANE])

print("Bash script created")
print(f"Name: {BASH_SCRIPT_NANE}")